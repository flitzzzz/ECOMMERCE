...
<div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="about_img"><img src="<?= base_url() ?>images/about-img.png"></div>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="services_section_2">
               <div class="row">
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main active">
                        <div class="house_icon">
                           <img src="<?= base_url() ?>images/icon1.png" class="image_1">
                           <img src="<?= base_url() ?>images/icon1.png" class="image_2">
                        </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main">
                        <div class="house_icon">
                           <img src="<?= base_url() ?>images/icon2.png" class="image_1">
                           <img src="<?= base_url() ?>images/icon2.png" class="image_2">
                        </div>
                  ...
                  <div class="col-lg-4 col-sm-12 col-md-4">
                     <div class="box_main">
                        <div class="house_icon">
                           <img src="<?= base_url() ?>images/icon3.png" class="image_1">
                           <img src="<?= base_url() ?>images/icon3.png" class="image_2">
                        </div>
                   ...
                   <div class="row">
                      <div class="col-md-12">
                         <div class="testimonial_section_2">
                            <h4 class="client_name_text">Monila <span class="quick_icon"><img src="<?= base_url() ?>images/quick-icon.png"></span></h4>
